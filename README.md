...
<div align='center'>
    <h1>Lead Tracker</h1>
    <p>A chrome extension to bookmark urls. Built with HTML, CSS, and JavaScript.</p>
...
* Load unpacked and naviagate to the downloaded file

[Check out this guide!](https://dev.to/ben/how-to-install-chrome-extensions-manually-from-github-1612)
